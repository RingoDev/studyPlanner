...
function removeCoursesFromGroupList(
  groups: Group[],
  toRemove: string[]
): Group[] {
  const result = [];
...
function moveCourseFromStorageToCurriculum(
  curriculum: CurriculumType,
  groups: Group[],
  groupId: string,
  courseId: string,
...
function moveCourseFromCurriculumToStorage(
  curriculum: CurriculumType,
  groups: Group[],
  groupId: string,
  courseId: string,
...
function checkSteopConstraints(
  state: INITIAL_STATE_TYPE,
  course: Course,
  semesterIndex: number
) {
...
function checkSemesterConstraints(
  state: INITIAL_STATE_TYPE,
  course: Course,
  semesterIndex: number
) {
