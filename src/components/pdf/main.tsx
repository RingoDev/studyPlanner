                        ...
                        <View style={tableStyles.table}>
                            <View style={{...tableStyles.tableRow, ...tableStyles.tableHead}}>
                                <View style={{...tableStyles.tableCell, ...tableStyles.description}}>
                                    <Text
                                        style={tableStyles.text}>{getSemesterName(index, startSemesterIndex)}</Text>
                                </View>
                            ...
                            {semester.courses.map((course, index) => (
                                <View key={index} style={tableStyles.tableRow}>
                                    <View style={{...tableStyles.tableCell, ...tableStyles.description}}>
                                        <Text style={tableStyles.text}>{course.sign} - {course.title}</Text>
                                    </View>
                                    <View style={{...tableStyles.tableCell}}>
                            ...
                            {semester.customEcts !== 0 ? (
                                <View key={index} style={tableStyles.tableRow}>
                                    <View style={{...tableStyles.tableCell, ...tableStyles.description}}>
                                        <Text style={tableStyles.text}>Freie Studienleistungen</Text>
                                    </View>
                                    <View style={{...tableStyles.tableCell}}>
