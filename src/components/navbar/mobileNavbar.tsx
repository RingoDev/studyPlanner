import {BarChart2, Calendar, Download, FileText, Menu, Settings, Upload} from "lucide-react";
import {
    Box,
    Button,
    CircularProgress,
...
const MobileNavbar = () => {
    ...
    return (
        <>
            <MobileMenuButton onClick={() => setMenuOpen(true)}><Menu/></MobileMenuButton>
                ...
                <Box sx={{width: 275}}
                    ...
                    <List>
                        ...
                        <MyNavLink to={"/progress"}>
                            <ListItem button>
                                <ListItemIcon><BarChart2/></ListItemIcon>
                    ...
                    <List>
                        ...
                        <StyledLinkWrapper>
                            <DownloadPDFLink loadingComponent={
                                <ListItem button>
